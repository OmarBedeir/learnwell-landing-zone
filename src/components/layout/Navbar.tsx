            ...
            <div className="hidden md:flex md:items-center md:space-x-6">
              ...
              <div className="flex items-center space-x-2">
                {user ? (
                  ...
                  <>
                    <Button variant="outline" size="sm" onClick={() => openAuthModal('signin')}>Log In</Button>
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white shadow-lg">
            ...
            <div className="pt-4 pb-3 flex flex-col space-y-2">
              {user ? (
                ...
                <>
                  <Button variant="outline" className="w-full justify-center" onClick={() => openAuthModal('signin')}>Log In</Button>
                  <Button className="w-full justify-center" onClick={() => openAuthModal('signup')}>Sign Up</Button>
                </>
              )}
            </div>
          </div>
